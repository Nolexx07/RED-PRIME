...
if(count > 0){ 
out.print("<br><br><center><h1 style='color:green'>USER 
REGISTERED </h1></center>"); 
RequestDispatcher rd= req.getRequestDispatcher("/reg.jsp"); 
rd.include(req, resp); 
} 
else 
{ 
out.print("<center><h1 style='color:red'>USER NOT REGISTERED DUE TO 
ERROR </h1></center>"); 
 RequestDispatcher rd= req.getRequestDispatcher("/reg.jsp"); 
rd.include(req, resp); 
 } 
...
e.printStackTrace(); 
out.print("<h3 style='color:red'>user 
registered"+e.getMessage()+"</h3>"); 
